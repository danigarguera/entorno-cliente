...
function attack() {
    ...
    // Mostrar el mensaje del ataque en el log
...
function updateBattleLog(message) {
    ...
    logContent.scrollTop = logContent.scrollHeight; // Desplazarse hacia abajo
}
...
// Evento para el botón de ataque
document.getElementById('attackButton').addEventListener('click', attack);

// Inicializar los datos de la batalla al cargar
setBattleData();

// Función para seleccionar un Pokémon aleatorio para el enemigo
